<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmStateMangement.aspx.cs" Inherits="DevStateManagement.FrmStateMangement" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            Application 개체: <asp:TextBox ID="txtViewState" runat="server"/><br />
            <hr />
