...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:CheckBoxList ID="chkFavorite" runat="server" ValidationGroup="MyForm">
            ...
            <asp:CustomValidator ID="ValidateCheckBoxList1" runat="server"
                ErrorMessage="반드시 하나 이상을 체크하세요." ClientValidationFunction="CheckValue"
                 ValidationGroup="MyForm" Display="None"/>
