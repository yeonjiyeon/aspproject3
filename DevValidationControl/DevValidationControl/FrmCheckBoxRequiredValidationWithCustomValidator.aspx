    ...
    <form id="form1" runat="server">
        <div class="form-group">
            ...
            <div class ="col-sm-10">
                ...
                <asp:TextBox ID="txtAgreement" runat="server" TextMode="MultiLine" Height="80px"
                    Width="100%" Style="font-size:9pt;"></asp:TextBox>
                <div class="checkbox">
                    <label>
                        <asp:CheckBox ID="chkConfirm" runat="server" Checked="false" />
                        <asp:Literal ID="strAcceptTehLicense" runat="server">
                            위 약관에 동의합니다.(Accept the license)
                        </asp:Literal>
                    </label>
                </div>
                <asp:CustomValidator ID="alConfirm" runat="server" ErrorMessage="약관에 동의하셔야 합니다."
