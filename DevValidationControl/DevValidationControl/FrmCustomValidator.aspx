    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:CustomValidator ID="valEvenNumber" runat="server" ErrorMessage="짝수만 입력하시오."
                ControlToValidate ="txtEvenNumber" OnServerValidate="valEvenNumber_ServerValidate"></asp:CustomValidator>
        <br />
            홀수만 입력:
            <asp:TextBox ID="txtOddNumber" runat="server"></asp:TextBox>
            <asp:CustomValidator ID="CustonValidator1" runat="server" ErrorMessage="홀수만 입력하시오."
                ControlToValidate="txtOddNumber" ClientValidationFunction="FuncValidationOddNumber">
            </asp:CustomValidator>
            <hr />
